...
import proto.llm_pb2 as llm__pb2
...
def add_OllamaServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'ollama.Ollama', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('ollama.Ollama', rpc_method_handlers)
